...
<div id="wrapper">
	<aside id="aside">
	    ...
	    <div id="aside_ct">
	        <div class="short_cut">
	            <ul>
                <li class="f_short_cut"><strong><a href="https://map.kakao.com/">🫕맹동근 맛집 리스트🫕</a></strong></li>
                <li><strong><a href="https://www.siksinhot.com/toplists/best/042334_cafe">☕맹동근 카페 리스트☕</a></strong></li>
                <li><strong><a href="https://m.blog.naver.com/seouldatepop/222232698924">🏃‍♂️맹동근 가볼만한 곳🏃‍♀️</a></strong></li>
                <li><strong><a href="https://www.accuweather.com/ko/kr/dongdaemun-gu/226004/hourly-weather-forecast/226004">☀️맹동근 오늘의 날씨🌧️</a></strong></li>
	            </ul>
	        </div>
	        <div class="aside_lt">
	            <?php
    ...
    <div id="container">
        <?php if (!defined("_INDEX_")) { ?><h2 id="container_title"><span title="<?php echo get_text($g5['title']); ?>"><?php echo get_head_title($g5['title']); ?></span>공지사항</h2><?php } ?>
